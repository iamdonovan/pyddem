...
ogr2ogr -t_srs "+proj=utm +zone=$UTM +ellps=WGS84 +datum=WGS84 +units=m +no_defs" -clipsrc $xminDeg $yminDeg $xmaxDeg $ymaxDeg water_zoneUTM.shp /uio/lagringshotell/geofag/icemass/icemass-research/Scripts/Aster_Pipeline/WaterPoly/water_polygons.shp water_polygons.shp
